...
# static fields
.field private static zzcls:Lcom/google/firebase/iid/zzg;


# instance fields
.field private final zzclt:Landroid/support/v4/util/SimpleArrayMap;
...
.field private zzclu:Ljava/lang/Boolean;

.field final zzclv:Ljava/util/Queue;
...
.field final zzclw:Ljava/util/Queue;
    .annotation build Landroid/support/annotation/VisibleForTesting;
    .end annotation
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/firebase/iid/zzg;->zzclt:Landroid/support/v4/util/SimpleArrayMap;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/google/firebase/iid/zzg;->zzclu:Ljava/lang/Boolean;

    new-instance v0, Ljava/util/LinkedList;

    invoke-direct {v0}, Ljava/util/LinkedList;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/iid/zzg;->zzclv:Ljava/util/Queue;

    new-instance v0, Ljava/util/LinkedList;

    invoke-direct {v0}, Ljava/util/LinkedList;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/iid/zzg;->zzclw:Ljava/util/Queue;
...
.method public static declared-synchronized zzabT()Lcom/google/firebase/iid/zzg;
    .locals 2
    ...
    :try_start_0
    sget-object v0, Lcom/google/firebase/iid/zzg;->zzcls:Lcom/google/firebase/iid/zzg;
    ...
    sput-object v0, Lcom/google/firebase/iid/zzg;->zzcls:Lcom/google/firebase/iid/zzg;
...
.method private zzcw(Landroid/content/Context;)Z
    .locals 1

    iget-object v0, p0, Lcom/google/firebase/iid/zzg;->zzclu:Ljava/lang/Boolean;
...
.method private zze(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    iget-object v1, p0, Lcom/google/firebase/iid/zzg;->zzclt:Landroid/support/v4/util/SimpleArrayMap;

    monitor-enter v1

    :try_start_0
    iget-object v0, p0, Lcom/google/firebase/iid/zzg;->zzclt:Landroid/support/v4/util/SimpleArrayMap;
    ...
    :try_start_2
    iget-object v2, p0, Lcom/google/firebase/iid/zzg;->zzclt:Landroid/support/v4/util/SimpleArrayMap;
...
.method private zzg(Landroid/content/Context;Landroid/content/Intent;)I
    ...
    :try_start_0
    invoke-direct {p0, p1}, Lcom/google/firebase/iid/zzg;->zzcw(Landroid/content/Context;)Z
...
# virtual methods
.method public zzabU()Landroid/content/Intent;
    .locals 1

    iget-object v0, p0, Lcom/google/firebase/iid/zzg;->zzclv:Ljava/util/Queue;
...
.method public zzabV()Landroid/content/Intent;
    ...
    iget-object v0, p0, Lcom/google/firebase/iid/zzg;->zzclw:Ljava/util/Queue;
